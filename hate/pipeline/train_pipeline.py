...
from hate.components.dara_ingestion import DataIngestion
from hate.components.data_transormation import DataTransformation
from hate.entity.config_entity import (DataIngestionConfig, DataTranformationConfig)
...
class TrainPipeline:
    ...
    def start_data_transformation(self,data_ingestion_artifacts=DataIngestionArtifacts) -> DataTransformationArtifacts:
        logging.info('enter the start_data_transformation method of Trainpipeline class')
        try:
