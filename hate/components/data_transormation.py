...
from hate.entity.config_entity import DataTranformationConfig
from hate.entity.artifact_entity import DataIngestionArtifacts, DataTransformationArtifacts


class DataTransformation:
    def __init__(self,data_transformation_config: DataTranformationConfig, data_ingestion_artifacts: DataIngestionArtifacts):
        self.data_transformation_config = data_transformation_config
        self.data_ingestion_artifacts = data_ingestion_artifacts

    def imbalance_data_cleaning(self):
        try:
            logging.info('Entered in to imbalance data cleaning function')
            ...
            logging.info(f'existed the imbalce data cleaning function and returned imbalce data {imbalance_data}')
    ...
    def raw_data_cleaning(self):
        try:
            logging.info('entered in to raw data cleaning fuction   ')
            ...
            #change name of the class to label
    ...
    def concat_dataframe(self):
        try:
            logging.info("entered in to the conact dataframe function")
            # concatinate both dataframes in to single dataframe
    ...
    def concat_data_cleaning(self,words):
        try:
            logging.info('Entered in to the concat_data_cleaning function')
    ...
    def initiate_data_transformation(self) ->DataIngestionArtifacts:
        try:
            logging.info('Entered in to initiate_data_transformation method of Data tranformation class')
